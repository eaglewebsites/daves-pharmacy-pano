    ...
    function Ba(K) {
            ...
            if (h) {
                ...
                for (x = 0; x < c.nodeCache.length; x++)
                    if (c.nodeCache[x].path == e.path) {
                        ...
                        c.nodeCache[
                            x
                        ].timestamp = c.nodeCacheTimestamp++
                ...
                if (e.level < c.level) {
                    ...
                    if (e.x == u || e.y == u)
                        t =
                            1 -
                            m.tileResolution / (m.tileResolution + k)
                    var y = 1 - t,
                        d = [],
                        s = t,
                        z = t,
        ...
        this.init = function (L, e, Ca, H, l, h, d, u) {
            ...
            if (
                ...
                throw (
                    (console.log(
                        'Error: invalid image type specified!'
                    ),
                    { type: 'config error' })
                )
            z = e
            ...
            if (
                ...
                l = function () {
                    var a = g.createElement('canvas')
                    a.className =
                        'pnlm-face pnlm-' + Q[this.side] + 'face'
                    R.appendChild(a)
                ...
                var D = function () {
                        ...
                        S++
                        6 == S &&
                            (($ = this.width), K.appendChild(R), d())
                    },
                    E = !1
                for (t = 0; 6 > t; t++)
                    (h = new Image()),
                        (h.crossOrigin = va.crossOrigin
                            ? va.crossOrigin
                            : 'anonymous'),
                        (h.side = t),
                        (h.onload = l),
                ...
                c.texCoordLocation = a.getAttribLocation(
                    c,
                    'a_texCoord'
                )
                ...
                'multires' != z
                    ? (ca || (ca = a.createBuffer()),
                      ...
                      (c.aspectRatio = a.getUniformLocation(
                          c,
                          'u_aspectRatio'
                      )),
                      a.uniform1f(
                      ...
                      'cubemap' == z
                          ...
                          : (a.uniform1i(
                            ...
                            a.uniform1i(
                                a.getUniformLocation(c, 'u_image1'),
                                1
                            ),
                    ...
                    : ((c.vertPosLocation = a.getAttribLocation(
                          c,
                          'a_vertCoord'
                      )),
                      ...
                      (c.perspUniform = a.getUniformLocation(
                          c,
                          'u_perspMatrix'
                      )),
                      (c.cubeUniform = a.getUniformLocation(
                          c,
                          'u_cubeMatrix'
                      )),
                      (c.level = -1),
            ...
            if (a || ('multires' != z && 'cubemap' != z)) {
                if ('multires' != z)
                    ...
                    if (
                        ...
                        c.nodeCache.length >
                            c.currentNodes.length + 50
                    )
                        for (
                            l = c.nodeCache.splice(
                                200,
                                c.nodeCache.length - 200
                            ),
                                d = 0;
                            d < l.length;
                            d++
                    ...
                    for (g = S.length - 1; 0 <= g; g--)
                        -1 === c.currentNodes.indexOf(S[g].node) &&
                            ((S[g].node.textureLoad = !1),
                            S.splice(g, 1))
                    if (0 === S.length)
                        for (g = 0; g < c.currentNodes.length; g++)
                            if (
                                ((e = c.currentNodes[g]),
                                !e.texture && !e.textureLoad)
                            ) {
                                e.textureLoad = !0
                                setTimeout(Ka, 0, e)
                                break
        ...
        var S = [],
            La = (function () {
                ...
                return function (c, h, m, p) {
                    ...
                    p = a.createTexture()
                    g
                        ? k[--g].loadTexture(h, p, m)
                        : S.push(new e(c, h, p, m))
                    return p
                }
            })()
    }
    ...
    function Ba(s, k) {
                ...
                if ('cubemap' == b.type) {
                    ...
                    (a = JSON.parse(JSON.stringify(b.multiRes))),
                        ...
                        !/^(?:[a-z]+:)?\/\//i.test(
                            ...
                            ? (a.basePath =
                                  b.basePath + b.multiRes.basePath)
                            : b.multiRes.basePath
                    ...
                    for (
                        var n = 6,
                            ...
                            d = function (a) {
                                ...
                                K(
                                    b.strings.fileAccessError.replace(
                                        '%s',
                                        ea.outerHTML
                                    )
                                )
        ...
        function pa() {
            ...
            Sa ||
                ...
                b.doubleClickZoom &&
                    W.addEventListener('dblclick', Ja, !1),
        ...
        function Ba(a) {
            ...
            f.addEventListener('loadend', function () {
                ...
                if (
                    ...
                    var c = n.indexOf('\u00ff\u00c2')
                    ;(0 > c || 65536 < c) &&
                        K(b.strings.iOS8WebGLError)
                }
                c = n.indexOf('<x:xmpmeta')
                if (-1 < c && !0 !== b.ignoreGPanoXMP) {
                    var d = n.substring(
                            c,
                            n.indexOf('</x:xmpmeta>') + 12
                        ),
                        e = function (a) {
                            var b
                            0 <= d.indexOf(a + '="')
                    ...
                    null !== n &&
                        ...
                        null !== m &&
                            null !== e &&
                            (0 > aa.indexOf('horizonPitch') &&
                                (b.horizonPitch = m),
                            0 > aa.indexOf('horizonRoll') &&
                                (b.horizonRoll = e)))
                }
        ...
        function ga() {
            if (G) {
                ...
                if (r[2] || r[6])
                    (b.pitch += (0.8 * w.pitch + 0.2) * d), (a = !0)
                if (r[3] || r[7])
                    (b.pitch += (0.8 * w.pitch - 0.2) * d), (a = !0)
                if (r[4] || r[8])
                    (b.yaw += (0.8 * w.yaw - 0.2) * d), (a = !0)
                if (r[5] || r[9])
                    (b.yaw += (0.8 * w.yaw + 0.2) * d), (a = !0)
                a && (N = Date.now())
                if (b.autoRotate) {
                ...
                0 < d &&
                    ...
                    (w.pitch =
                        0.8 * w.pitch + ((b.pitch - f) / d) * 0.2),
                    (w.hfov =
                        0.8 * w.hfov + ((b.hfov - c) / d) * 0.2),
        ...
        function ca() {
            if (!Za)
                if ((Fa(), Qa && clearTimeout(Qa), ha || !0 === X))
                    ...
                    ba = p
                    var a =
                        b.autoRotateInactivityDelay - (Date.now() - N)
                    0 < a
        ...
        function na(a) {
            ...
            f = f.multiply(
                new Y(Math.sqrt(0.5), -Math.sqrt(0.5), 0, 0)
            )
            c = E.orientation
        ...
        function va() {
            try {
                ...
                if ('webgl error' == f.type || 'no webgl' == f.type)
                    K()
        ...
        function La(a) {
            ...
            f.className = a.cssClass
                ? f.className + (' ' + a.cssClass)
                : f.className +
                  (' pnlm-hotspot pnlm-sprite pnlm-' + D(a.type))
            ...
            if (a.video) {
                ...
                if (a.attributes)
                    for (e in a.attributes)
                        d.setAttribute(e, a.attributes[e])
            ...
            if (a.createTooltipFunc)
                a.createTooltipFunc(f, a.createTooltipArgs)
        ...
        function e() {
            ...
            if (a)
                for (var f = 0; f < a.length; f++) {
                    var c = a[f].div
                    if (c) {
                        for (; c.parentNode && c.parentNode != M; )
                            c = c.parentNode
                        M.removeChild(c)
                    }
                    delete a[f].div
            ...
            for (f in k)
                if (k.hasOwnProperty(f))
                    if ('strings' == f)
                        ...
                        (b[f] = k[f]), 0 <= d.indexOf(f) && aa.push(f)
        }
        function l(a) {
                    ...
                    switch (e) {
                        ...
                        case 'author':
                            ...
                            b.authorURL &&
                                ...
                                (h.innerHTML = D(b[e])),
                                (h = h.outerHTML))
                            q.author.innerHTML = b.strings.bylineLabel.replace(
                                '%s',
                                h
                            )
                            q.container.style.display = 'inline'
        ...
        function u(a) {
            ...
            'multires' == b.type &&
                ...
                (c = Math.min(
                    c,
                    C.getCanvas().width /
                        ((b.multiRes.cubeResolution / 90) * 0.9)
                ))
            if (c > b.maxHfov)
                return (
                    console.log(
        ...
        function y(a, c, d, h, g) {
            ...
            if (
                ...
                g.style.transition =
                    'opacity ' + b.sceneFadeDuration / 1e3 + 's'
                g.style.width = '100%'
                g.style.height = '100%'
                g.onload = function () {
                    y(a, c, d, h, !0)
        ...
        function Da() {
            ...
            v.orientation.classList.remove(
        ...
        function I(a, b) {
            ...
            return 0 === c.indexOf('javascript:') ||
                0 === c.indexOf('vbscript:')
        ...
        var da = this,
            ...
            Va = {
                ...
                strings: {
                    ...
                    unknownError:
                        'Unknown error. Check developer console.',
                },
            }
        ...
        this.removeScene = function (a) {
            if (b.scene === a || !k.scenes.hasOwnProperty(a))
                return !1
            delete k.scenes[a]
            return !0
        }
            ...
            if (c === p && b.scene === p) b.hotSpots.push(a)
                ...
                if (k.scenes.hasOwnProperty(d))
                    k.scenes[d].hasOwnProperty('hotSpots') ||
                        ((k.scenes[d].hotSpots = []),
                        d == b.scene &&
                            (b.hotSpots = k.scenes[d].hotSpots)),
        ...
        this.removeHotSpot = function (a, c) {
            if (c === p || b.scene == c) {
                ...
                for (d = 0; d < k.scenes[c].hotSpots.length; d++)
                    if (
                        k.scenes[c].hotSpots[d].hasOwnProperty(
                            'id'
                        ) &&
